...
public class GetUsersForGroupActivity extends Activity implements OnClickListener {
    ...
    private ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, R.id.button_Get_Users_For_Group_Users_List, values);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)this.findViewById(R.id.button_Get_Users_For_Group_Users_List);
